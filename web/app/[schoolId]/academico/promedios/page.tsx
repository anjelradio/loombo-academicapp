...
export default async function AcademicoPromediosPage({
  params,
}: {
    ...
    <>
      ...
      <ContentGridSurface variant="mist">
        <PageHeading
          ...
          description="Revisa cursos y materias para consultar y calcular promedios trimestrales por estudiante."
          tone="light"
        />
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(260px,30%)_minmax(0,70%)]">
          <div className="space-y-5">
            <IndicatorsSummaryCard
              ...
              description="Estos indicadores se activaran en siguientes iteraciones del tablero academico."
              items={[
