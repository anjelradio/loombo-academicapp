...
export default async function DocentePromediosAssignmentPage({
  params,
  searchParams,
}: {
    ...
    <>
      ...
      <ContentGridSurface variant="mist">
        <PageHeading
          ...
          tone="light"
          returnHref={`/${schoolId}/docente/promedios`}
              ...
              <div className="flex flex-wrap gap-2">
                {termOptions.map((term) => {
                  ...
                  return (
                    <Link
                      key={term.id}
                      href={`/${schoolId}/docente/promedios/${assignmentId}?term=${encodeURIComponent(term.name)}`}
